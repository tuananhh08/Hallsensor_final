...
# parser.add_argument("--calib",      default="Calibration_GRID_NEW_PARAM_results.csv")
...
# BASE_DIR = Path(r"D:\Downloads\Hallsensor_final\Data set\Coordinate") # WINDOWS
...
# # Moment vector cố định (1, 0, 0)
# m_vecs = np.tile([1.0, 0.0, 0.0], (N, 1))                          # (N, 3)
